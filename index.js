  ...
  let artistsNames = [];
    for(let i = 0; i < array.length; i++) {  
      ...
      //console.log(array[i].years.split(" - "));
       if(array[i].years.split(" - ")[0] >= '1900' && array[i].years.split(" - ")[1] <= '1999') {
      //console.log(array[i]);
...
function addArtist(array){
  ...
  array.push({id: 20, name: "Meg", years: "1985 - 2020", genre: "Web Design", nationality: "American", bio: "Frustrated but determined to finsih this sprint challenge in the remaining 40 minutes. Probably caught up on something really dumb! GAH"});
