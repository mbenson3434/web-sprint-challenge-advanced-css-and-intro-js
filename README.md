...
1. How would you describe acessibility on the web to someone new to programming?
    Accessabilty makes it possibly for screen readers to decribe what is happening on the page to blind people and other visual imparments. 
2. Talk about 3 different things you can do to ensure your website is accessible. 
    Use semantic html, use responsive elements like rems or %, use alt tags and role tags 
3. How would you explain the concept of a variable to someone new to programming?
    A variable points to a spot in memory that holds information. 
4. What is the purpose of using functions in code?
    functions compartmentalizes code so that pieces that be used when needed but not affected by things that are going on in other parts of the code. A function must be called to work. 
